...
public class DataSourceManager
{
    ...
    public synchronized static BasicDataSource getDataSource() throws IOException
    {
        if (singletonDS == null) {
            ...
            singletonDS.setUrl(url.trim());
            singletonDS.setUsername(id.trim());
            singletonDS.setPassword(passwd.trim());
            singletonDS.setMaxWaitMillis(5000);
            //singletonDS.setMaxTotal(100);
