...
public class PopulateTables
{
    ...
    public static void main(String args[])
    {
        try {
            ...
            System.out.println("Finished building gamesOwned: " + gamesOwned.size());
            ...
            System.out.println("Finished building gamesPlayed: " + gamesPlayed.size());
            app.insertGamesPlayed(connection, gamesPlayed);
            System.out.println("Finished inserting gamesPlayed");

            connection.commit();
            System.out.println("Finished Initializing Games Database");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
